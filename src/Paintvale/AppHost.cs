...
using Paintvale.Audio.Backends.Dummy;
using Paintvale.Audio.Backends.OpenAL;
using Paintvale.Audio.Backends.SDL2;
using Paintvale.Audio.Backends.SoundIo;
...
using Paintvale.Common.Configuration.Multiplayer;
using Paintvale.Common.Logging;
using Paintvale.Common.SystemInterop;
using Paintvale.Common.UI;
using Paintvale.Common.Utilities;
using Paintvale.Graphics.GAL;
using Paintvale.Graphics.GAL.Multithreading;
using Paintvale.Graphics.Gpu;
using Paintvale.Graphics.OpenGL;
using Paintvale.Graphics.Vulkan;
using Paintvale.HLE;
...
using static Paintvale.Ava.UI.Helpers.Win32NativeInterop;
using AntiAliasing = Paintvale.Common.Configuration.AntiAliasing;
using InputManager = Paintvale.Input.HLE.InputManager;
using IRenderer = Paintvale.Graphics.GAL.IRenderer;
...
namespace Paintvale.Ava
{
    internal class AppHost
    {
        ...
        private void Exit()
        {
            ...
            foreach (IGamepad gamepad in PaintvaleApp.MainWindow.InputManager.GamepadDriver.GetGamepads())
            {
                gamepad?.ClearLed();
                gamepad?.Dispose();
            }
                    ...
                    default:
                        {
                            ...
                            {
                                Logger.Error?.Print(LogClass.Application, "The specified file is not supported by Paintvale.");
        ...
        private void RenderLoop()
        {
            ...
            Dispatcher.UIThread.Post(() => PaintvaleApp.MainWindow.LoadApplications());
        }
