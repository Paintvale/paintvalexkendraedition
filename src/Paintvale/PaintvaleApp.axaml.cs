...
{
    public class PaintvaleApp : Application
    {
        ...
        public static readonly string FullAppName = string.Intern(ReleaseInformation.IsCanaryBuild ? "Paintvale Canary" : "Paintvale");
        ...
        public override void Initialize()
        {
            ...
            {
                Process.Start("/usr/bin/defaults", "write org.paintvale.Paintvale ApplePressAndHoldEnabled -bool false");
            }
        }
        ...
        public static ThemeVariant DetectSystemTheme() =>
            Current is PaintvaleApp { PlatformSettings: not null } app
