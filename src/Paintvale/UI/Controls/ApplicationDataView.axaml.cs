...
using Paintvale.Ava.Utilities.Compat;
using System.Linq;
...
namespace Paintvale.Ava.UI.Controls
{
    public partial class ApplicationDataView : UserControl
    {
        ...
        private async void PlayabilityStatus_OnClick(object sender, RoutedEventArgs e)
        {
            ...
            if (PaintvaleApp.AppLifetime.Windows.TryGetFirst(x => x is ContentDialogOverlayWindow, out Window window))
        ...
        private async void IdString_OnClick(object sender, RoutedEventArgs e)
        {
            ...
            if (!PaintvaleApp.IsClipboardAvailable(out IClipboard clipboard))
                return;
