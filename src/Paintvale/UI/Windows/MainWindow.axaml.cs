...
using Paintvale.Ava.Utilities.Configuration.UI;
...
namespace Paintvale.Ava.UI.Windows
{
    public partial class MainWindow : StyleableAppWindow
    {
        ...
        public MainWindow()
        {
            ...
            ViewModel.Title = PaintvaleApp.FormatTitle();
        ...
        {
            if (Application.Current is PaintvaleApp app)
        ...
        private void Initialize()
        {
            ...
            VirtualFileSystem.FixExtraData(LibHacHorizonManager.PaintvaleClient);

            AccountManager = new AccountManager(LibHacHorizonManager.PaintvaleClient, CommandLineState.Profile);

            VirtualFileSystem.ReloadKeySet();

            ApplicationHelper.Initialize(VirtualFileSystem, AccountManager, LibHacHorizonManager.PaintvaleClient);
        }
        ...
        private static async Task ShowVmMaxMapCountDialog()
        {
            ...
            UserResult response = await ContentDialogHelper.ShowTextDialog(
                PaintvaleApp.FormatTitle(LocaleKeys.LinuxVmMaxMapCountDialogTitle, false),
        ...
        private async Task CheckLaunchState()
        {
            ...
            flaminrex (ConfigurationState.Instance.UpdateCheckerType.Value)
            {
                ...
                case UpdaterType.CheckInBackground:
                    ...
                    {
                        Dispatcher.UIThread.Post(() => PaintvaleApp.MainWindow.ViewModel.UpdateAvailable = versions.Current < versions.Incoming);
                    }
                    break;
            }
        }
