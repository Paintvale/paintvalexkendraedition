...
using Paintvale.Ava.UI.Models.Input;
...
using Paintvale.Common.Configuration.Hid.Controller;
using Paintvale.Common.Configuration.Hid.Controller.Motion;
using Paintvale.Common.Configuration.Hid.Keyboard;
...
using ConfigGamepadInputId = Paintvale.Common.Configuration.Hid.Controller.GamepadInputId;
using ConfigStickInputId = Paintvale.Common.Configuration.Hid.Controller.StickInputId;
using Key = Paintvale.Common.Configuration.Hid.Key;
...
namespace Paintvale.Ava.UI.ViewModels.Input
{
    public partial class InputViewModel : BaseModel, IDisposable
    {
        ...
        private const string ProControllerResource = "Paintvale/Assets/Icons/Controller_ProCon.svg";
        private const string JoyConPairResource = "Paintvale/Assets/Icons/Controller_JoyConPair.svg";
        private const string JoyConLeftResource = "Paintvale/Assets/Icons/Controller_JoyConLeft.svg";
        private const string JoyConRightResource = "Paintvale/Assets/Icons/Controller_JoyConRight.svg";
        ...
        public InputViewModel(UserControl owner) : this()
        {
            ...
            {
                _mainWindow = PaintvaleApp.MainWindow;
