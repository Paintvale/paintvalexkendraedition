...
namespace Paintvale.Ava.UI.ViewModels
{
    public partial class SettingsViewModel : BaseModel
    {
        ...
        public bool IsScalingFilterActive => _scalingFilter == (int)Paintvale.Common.Configuration.ScalingFilter.Fsr;
        ...
        public void SaveSettings()
        {
            ...
            PaintvaleApp.MainWindow.ViewModel.VSyncModeSettingChanged();
        ...
        public AsyncRelayCommand ResetButton => Commands.Create(async () =>
        {
            ...
            await ContentDialogHelper.CreateInfoDialog(
                $"Your {PaintvaleApp.FullAppName} configuration has been reset.",
                "",
                string.Empty,
