...
using Paintvale.Ava.Common.Models.Amiibo;
...
namespace Paintvale.Ava.UI.ViewModels
{
    public class AmiiboWindowViewModel : BaseModel, IDisposable
    {
        ...
        public AmiiboWindowViewModel(AmiiboWindow owner, string lastScannedAmiiboId, string titleId)
        {
            ...
            _amiiboLogoBytes = EmbeddedResources.Read("Paintvale/Assets/UIImages/Logo_Amiibo.png");
        ...
        private async Task<bool> NeedsUpdate(DateTime oldLastModified)
        {
            try
            {
                HttpResponseMessage response = await _httpClient.SendAsync(new HttpRequestMessage(HttpMethod.Head, "https://raw.githubusercontent.com/Ryubing/Paintvale/refs/heads/master/assets/amiibo/Amiibo.json"));
        ...
        private async Task<string> DownloadAmiiboJson()
        {
            try
            {
                HttpResponseMessage response = await _httpClient.GetAsync($"https://raw.githubusercontent.com/Ryubing/Paintvale/refs/heads/master/assets/amiibo/Amiibo.json");
