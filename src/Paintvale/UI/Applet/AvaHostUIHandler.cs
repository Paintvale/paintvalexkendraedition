...
using Paintvale.HLE.HOS.Applets.SoftwareKeyboard;
...
namespace Paintvale.Ava.UI.Applet
{
    internal class AvaHostUIHandler : IHostUIHandler
    {
        ...
        public UserProfile ShowPlayerSelectDialog()
        {
            ...
            byte[] defaultGuestImage = EmbeddedResources.Read("Paintvale.HLE/HOS/Services/Account/Acc/GuestUserImage.jpg");
