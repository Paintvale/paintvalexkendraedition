...
using Paintvale.Ava.Common.Models.Github;
...
namespace Paintvale.Ava
{
    internal static class Updater
    {
        ...
        public static async Task<Optional<(Version Current, Version Incoming)>> CheckVersionAsync(bool showVersionUpToDate = false)
        {
            ...
            {
                Logger.Error?.Print(LogClass.Application, $"Failed to convert the current {PaintvaleApp.FullAppName} version!");
            ...
            try
            {
                ...
                {
                    if (asset.Name.StartsWith("paintvale") && asset.Name.EndsWith(_platformExt))
                    {
            ...
            {
                Logger.Error?.Print(LogClass.Application, $"Failed to convert the received {PaintvaleApp.FullAppName} version from GitHub!");
        ...
        public static async Task BeginUpdateAsync(bool showVersionUpToDate = false)
        {
            ...
            RequestUserToUpdate:
                ...
                UserResult shouldUpdate = await ContentDialogHelper.CreateUpdaterChoiceDialog(
                    LocaleManager.Instance[LocaleKeys.PaintvaleUpdater],
        ...
        private static HttpClient ConstructHttpClient()
        {
            ...
            result.DefaultRequestHeaders.Add("User-Agent", "Paintvale-Updater/1.0.0");

            return result;
        }

        private static async Task UpdatePaintvale(string downloadUrl)
        {
            ...
            {
                Header = LocaleManager.Instance[LocaleKeys.PaintvaleUpdater],
            ...
            if (_updateSuccessful)
            {
                ...
                {
                    shouldRestart = await ContentDialogHelper.CreateChoiceDialog(LocaleManager.Instance[LocaleKeys.PaintvaleUpdater],
                ...
                if (shouldRestart)
                {
                    ...
                    if (OperatingSystem.IsMacOS())
                    {
                        ...
                        string newBundlePath = Path.Combine(_updateDir, "Paintvale.app");
...
#pragma warning restore SYSLIB0014
        ...
        private static void DoUpdateWithSingleThreadWorker(TaskDialog taskDialog, string downloadUrl, string updateFile)
        {
            ...
            while (true)
            {
                ...
                PaintvaleApp.SetTaskbarProgressValue(bytesWritten, totalBytes);
