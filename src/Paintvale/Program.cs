...
using Paintvale.Ava.Utilities.SystemInfo;
...
namespace Paintvale.Ava
{
    internal partial class Program
    {
        ...
        public static int Main(string[] args)
        {
            ...
            {
                _ = MessageBoxA(nint.Zero, "You are running an outdated version of Windows.\n\nPaintvale supports Windows 10 version 20H1 and newer.\n", $"Paintvale {Version}", MbIconwarning);
                return 0;
            }
            ...
            {
                HeadlessPaintvale.Entrypoint(args[1..]);
                return 0;
            }
        ...
        public static AppBuilder BuildAvaloniaApp() =>
            AppBuilder.Configure<PaintvaleApp>()
                .UsePlatformDetect()
        ...
        private static void Initialize(string[] args)
        {
            ...
            Console.Title = $"{PaintvaleApp.FullAppName} Console {Version}";
        ...
        public static void ReloadConfig()
        {
            ...
            if (CommandLineState.OverrideSystemRegion is not null)
                if (Enum.TryParse(CommandLineState.OverrideSystemRegion, true, out Paintvale.HLE.HOS.SystemState.RegionCode result))
                {
            ...
            if (CommandLineState.OverrideSystemLanguage is not null)
                if (Enum.TryParse(CommandLineState.OverrideSystemLanguage, true, out Paintvale.HLE.HOS.SystemState.SystemLanguage result))
                {
        ...
        {
            Logger.Notice.Print(LogClass.Application, $"{PaintvaleApp.FullAppName} Version: {Version}");
