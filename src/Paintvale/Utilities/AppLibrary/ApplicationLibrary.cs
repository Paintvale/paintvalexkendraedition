...
using Paintvale.Ava.Utilities.Configuration.System;
...
using Paintvale.HLE.Loaders.Npdm;
using Paintvale.HLE.Loaders.Processes.Extensions;
using Paintvale.HLE.Utilities;
using System;
...
namespace Paintvale.Ava.Utilities.AppLibrary
{
    public class ApplicationLibrary
    {
        ...
        public ApplicationLibrary(VirtualFileSystem virtualFileSystem, IntegrityCheckLevel checkLevel)
        {
            ...
            _nspIcon = EmbeddedResources.Read("Paintvale/Assets.UIImages.Icon_NSP.png");
            _xciIcon = EmbeddedResources.Read("Paintvale/Assets.UIImages.Icon_XCI.png");
            _ncaIcon = EmbeddedResources.Read("Paintvale/Assets.UIImages.Icon_NCA.png");
            _nroIcon = EmbeddedResources.Read("Paintvale/Assets.UIImages.Icon_NRO.png");
            _nsoIcon = EmbeddedResources.Read("Paintvale/Assets.UIImages.Icon_NSO.png");
        }

        /// <exception cref="Paintvale.HLE.Exceptions.InvalidNpdmException">The npdm file doesn't contain valid data.</exception>
