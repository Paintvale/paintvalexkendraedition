...
namespace Paintvale.Ava.Utilities
{
    public static class ShortcutHelper
    {
        ...
        {
            string basePath = Path.Combine(AppDomain.CurrentDomain.BaseDirectory, "Paintvale.sh");
            string desktopFile = EmbeddedResources.ReadAllText("Paintvale/Assets/ShortcutFiles/shortcut-template.desktop");
            iconPath += ".png";
        ...
        {
            string basePath = Path.Combine(AppDomain.CurrentDomain.BaseDirectory, "Paintvale");
            string plistFile = EmbeddedResources.ReadAllText("Paintvale/Assets/ShortcutFiles/shortcut-template.plist");
            string shortcutScript = EmbeddedResources.ReadAllText("Paintvale/Assets/ShortcutFiles/shortcut-launch-script.sh");
            // Macos .App folder
        ...
        public static void CreateAppShortcut(string applicationFilePath, string applicationName, string applicationId, byte[] iconData, string args = "")
        {
            ...
            {
                string iconPath = Path.Combine(Environment.GetFolderPath(Environment.SpecialFolder.UserProfile), ".local", "share", "icons", "Paintvale");
