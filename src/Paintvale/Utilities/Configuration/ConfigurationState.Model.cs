...
using System.Linq;
using RyuLogger = Paintvale.Common.Logging.Logger;
...
namespace Paintvale.Ava.Utilities.Configuration
{
    public partial class ConfigurationState
    {
        ...
        public class HidSection
        {
            ...
            /// <summary>
            /// Enable/disable the ability to control Paintvale when it's not the currently focused window.
            /// </summary>
        ...
        /// <summary>
        /// Checks for updates when Paintvale starts when enabled
        /// </summary>
        public ReactiveObject<bool> CheckUpdatesOnStart { get; private set; }
        
        /// <summary>
        /// Checks for updates when Paintvale starts when enabled, either prompting when an update is found or just showing a notification.
        /// </summary>
