...
using Paintvale.Common.GraphicsDriver;
using Paintvale.Common.Logging;
using Paintvale.Common.Logging.Targets;
...
using Paintvale.Graphics.Gpu.Shader;
using Paintvale.Graphics.Vulkan.MoltenVK;
using Paintvale.HLE;
...
using Paintvale.Input.SDL2;
using Paintvale.SDL2.Common;
using System;
...
{
    public partial class HeadlessPaintvale
    {
        ...
        public static void Entrypoint(string[] args)
        {
            ...
            Console.Title = $"HeadlessPaintvale Console {Program.Version}";
        ...
        static void Load(string[] originalArgs, Options option)
        {
            ...
            _accountManager = new AccountManager(_libHacHorizonManager.PaintvaleClient, option.UserProfile);
            ...
            if (!option.DisableFileLog)
            {
                ...
                {
                    Logger.Error?.Print(LogClass.Application, "No writable log directory available. Make sure either the Logs directory, Application Data, or the Paintvale directory is writable.");
                }
            }
