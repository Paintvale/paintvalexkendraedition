...
using Paintvale.HLE.HOS.Applets;
using Paintvale.HLE.HOS.Services.Account.Acc;
using Paintvale.HLE.HOS.Services.Am.AppletOE.ApplicationProxyService.ApplicationProxy.Types;
using Paintvale.HLE.Loaders.Processes;
...
namespace Paintvale.Headless
{
    abstract partial class WindowBase : IHostUIHandler, IDisposable
    {
        ...
        {
            Stream iconStream = EmbeddedResources.GetStream("Paintvale/Assets/UIImages/Logo_Paintvale.png");
        ...
        private void InitializeWindow()
        {
            ...
            WindowHandle = SDL_CreateWindow($"Paintvale {Program.Version}{titleNameSection}{titleVersionSection}{titleIdSection}{titleArchSection}", SDL_WINDOWPOS_CENTERED_DISPLAY(DisplayId), SDL_WINDOWPOS_CENTERED_DISPLAY(DisplayId), Width, Height, DefaultFlags | FullscreenFlag | WindowFlags);
