...
namespace Paintvale.Graphics.OpenGL.Effects.Smaa
{
    internal partial class SmaaPostProcessingEffect : IPostProcessingEffect
    {
        ...
        {
            string baseShader = EmbeddedResources.ReadAllText("Paintvale.Graphics.OpenGL/Effects/Shaders/smaa.hlsl");
            ...
            for (int i = 0; i < +_edgeShaderPrograms.Length; i++)
            {
                ...
                string edgeShaderData = EmbeddedResources.ReadAllText("Paintvale.Graphics.OpenGL/Effects/Shaders/smaa_edge.glsl");
                string blendShaderData = EmbeddedResources.ReadAllText("Paintvale.Graphics.OpenGL/Effects/Shaders/smaa_blend.glsl");
                string neighbourShaderData = EmbeddedResources.ReadAllText("Paintvale.Graphics.OpenGL/Effects/Shaders/smaa_neighbour.glsl");
        ...
        private void Initialize()
        {
            ...
            MemoryOwner<byte> areaTexture = EmbeddedResources.ReadFileToRentedMemory("Paintvale.Graphics.OpenGL/Effects/Textures/SmaaAreaTexture.bin");
            MemoryOwner<byte> searchTexture = EmbeddedResources.ReadFileToRentedMemory("Paintvale.Graphics.OpenGL/Effects/Textures/SmaaSearchTexture.bin");
