...
using System;
using static Paintvale.Graphics.OpenGL.Effects.ShaderHelper;
...
namespace Paintvale.Graphics.OpenGL.Effects
{
    internal class FsrScalingFilter : IScalingFilter
    {
        ...
        {
            string scalingShader = EmbeddedResources.ReadAllText("Paintvale.Graphics.OpenGL/Effects/Shaders/fsr_scaling.glsl");
            string sharpeningShader = EmbeddedResources.ReadAllText("Paintvale.Graphics.OpenGL/Effects/Shaders/fsr_sharpening.glsl");
            string fsrA = EmbeddedResources.ReadAllText("Paintvale.Graphics.OpenGL/Effects/Shaders/ffx_a.h");
            string fsr1 = EmbeddedResources.ReadAllText("Paintvale.Graphics.OpenGL/Effects/Shaders/ffx_fsr1.h");
