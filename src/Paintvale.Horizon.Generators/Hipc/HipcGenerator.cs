...
namespace Paintvale.Horizon.Generators.Hipc
{
    [Generator]
    class HipcGenerator : ISourceGenerator
    {
        ...
        private const string TypeResult = "Paintvale.Horizon.Common.Result";
        private const string TypeBufferAttribute = "Paintvale.Horizon.Sdk.Sf.BufferAttribute";
        private const string TypeCopyHandleAttribute = "Paintvale.Horizon.Sdk.Sf.CopyHandleAttribute";
        private const string TypeMoveHandleAttribute = "Paintvale.Horizon.Sdk.Sf.MoveHandleAttribute";
        private const string TypeClientProcessIdAttribute = "Paintvale.Horizon.Sdk.Sf.ClientProcessIdAttribute";
        private const string TypeCommandAttribute = "Paintvale.Horizon.Sdk.Sf." + CommandAttributeName;
        private const string TypeIServiceObject = "Paintvale.Horizon.Sdk.Sf.IServiceObject";
        ...
        public void Execute(GeneratorExecutionContext context)
        {
            ...
            foreach (CommandInterface commandInterface in syntaxReceiver.CommandInterfaces)
            {
                ...
                generator.AppendLine("using Paintvale.Horizon.Common;");
                generator.AppendLine("using Paintvale.Horizon.Sdk.Sf;");
                generator.AppendLine("using Paintvale.Horizon.Sdk.Sf.Cmif;");
                generator.AppendLine("using Paintvale.Horizon.Sdk.Sf.Hipc;");
