...
namespace Paintvale.Horizon.Kernel.Generators
{
    [Generator]
    class SyscallGenerator : ISourceGenerator
    {
        private const string ClassNamespace = "Paintvale.HLE.HOS.Kernel.SupervisorCall";
        ...
        private const string NamespaceKernel = "Paintvale.HLE.HOS.Kernel";
        private const string NamespaceHorizonCommon = "Paintvale.Horizon.Common";
        ...
        public void Execute(GeneratorExecutionContext context)
        {
            ...
            generator.AppendLine("using Paintvale.Common.Logging;");
            generator.AppendLine("using Paintvale.Cpu;");
