...
namespace Paintvale.HLE.HOS.Applets.SoftwareKeyboard
{
    ...
    internal class SoftwareKeyboardRendererBase
    {
        ...
        private readonly SKBitmap _paintvaleLogo = null;
        ...
        {
            int paintvaleLogoSize = 32;

            string paintvaleIconPath = "Paintvale.HLE.HOS.Applets.SoftwareKeyboard.Resources.Logo_Paintvale.png";
            _paintvaleLogo = LoadResource(typeof(SoftwareKeyboardRendererBase).Assembly, paintvaleIconPath, paintvaleLogoSize, paintvaleLogoSize);

            string padAcceptIconPath = "Paintvale.HLE.HOS.Applets.SoftwareKeyboard.Resources.Icon_BtnA.png";
            string padCancelIconPath = "Paintvale.HLE.HOS.Applets.SoftwareKeyboard.Resources.Icon_BtnB.png";
            string keyModeIconPath = "Paintvale.HLE.HOS.Applets.SoftwareKeyboard.Resources.Icon_KeyF6.png";
        ...
        private void DrawImmutableElements()
        {
            ...
            canvas.DrawBitmap(_paintvaleLogo, _logoPosition);
        ...
        private void ComputeConstants()
        {
            ...
            int logoPositionX = (totalWidth - _paintvaleLogo.Width) / 2;
