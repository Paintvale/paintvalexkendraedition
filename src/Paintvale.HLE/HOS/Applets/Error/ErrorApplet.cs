...
#pragma warning restore IDE0055
        ...
        private string GetMessageText(uint module, uint description, string key)
        {
            ...
            using LibHac.Fs.IStorage ncaFileStream = new LocalStorage(FileSystem.VirtualFileSystem.FlaminrexPathToSystemPath(binaryTitleContentPath), FileAccess.Read, FileMode.Open);
