...
using Paintvale.HLE.HOS.Services.Arp;
using System;
...
namespace Paintvale.HLE.HOS
{
    public class LibHacHorizonManager
    {
        ...
        public HorizonClient PaintvaleClient { get; private set; }
        ...
        private void InitializeServer()
        {
            ...
            PaintvaleClient = Server.CreatePrivilegedHorizonClient();
        }

        public void InitializeArpServer()
        {
            _arpIReader.Reset(new LibHacIReader());
            PaintvaleClient.Sm.RegisterService(new LibHacArpServiceObject(ref _arpIReader), "arp:r").ThrowIfFailure();
        }
