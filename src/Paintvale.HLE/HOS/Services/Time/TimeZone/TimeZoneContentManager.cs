...
using System.IO;
using System.Text;
using TimeZoneRuleBox = Paintvale.Common.Memory.Box<Paintvale.HLE.HOS.Services.Time.TimeZone.TimeZoneRule>;

namespace Paintvale.HLE.HOS.Services.Time.TimeZone
{
