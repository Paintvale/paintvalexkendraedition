...
using Paintvale.Cpu;
using Paintvale.HLE.HOS.Services.Sockets.Nsd.Manager;
using Paintvale.HLE.HOS.Services.Sockets.Sfdnsres.Proxy;
using Paintvale.HLE.HOS.Services.Sockets.Sfdnsres.Types;
...
namespace Paintvale.HLE.HOS.Services.Sockets.Sfdnsres
{
    [Service("sfdnsres")]
