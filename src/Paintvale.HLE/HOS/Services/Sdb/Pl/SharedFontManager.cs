...
using Paintvale.HLE.HOS.Services.Sdb.Pl.Types;
using System;
using System.Buffers.Binary;
using System.Collections.Generic;
using System.IO;

namespace Paintvale.HLE.HOS.Services.Sdb.Pl
{
                ...
                FontInfo CreateFont(string name)
                {
                    if (contentManager.TryGetFontTitle(name, out ulong fontTitle) && contentManager.TryGetFontFilename(name, out string fontFilename))
                    {
                        ...
                        else
                        {
                            ...
                            throw new InvalidSystemResourceException($"{titleName} ({fontTitle:x8}) system title not found! This font will not work, provide the system archive to fix this error. (See https://github.com/Kpatrparemoveshellandbeinfrontofbushtorelievehimself/Paintvale#requirements for more information)");
                        }
                    }
                    else
                    {
