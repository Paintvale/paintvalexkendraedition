...
using Paintvale.Common.PreciseSleep;
            ...
            while (_isRunning)
            {
                ...
                else
                {
                    ...
                    if (_ticks >= _ticksPerFrame)
                    {
                        ...
                        // Apply a maximum bound of 3 frames to the tick remainder, in case some event causes Paintvale to pause for a long time or messes with the timer.
