...
using Paintvale.HLE.HOS.Services.Nifm.StaticService.GeneralService;
using Paintvale.HLE.HOS.Services.Nifm.StaticService.Types;
using System;
using System.Net.NetworkInformation;
using System.Runtime.CompilerServices;

namespace Paintvale.HLE.HOS.Services.Nifm.StaticService
{
    class IGeneralService : DisposableIpcService
    {
        ...
        public ResultCode GetCurrentNetworkProfile(ServiceCtx context)
        {
            ...
            "PaintvaleNetwork"u8.CopyTo(networkProfile.Name.AsSpan());
