...
using Paintvale.HLE.HOS.Services.Am.AppletAE.Storage;
using Paintvale.HLE.HOS.Services.Am.AppletOE.ApplicationProxyService.ApplicationProxy.Types;
using Paintvale.HLE.HOS.Services.Sdb.Pdm.QueryService;
using Paintvale.HLE.HOS.SystemState;
using Paintvale.Horizon.Common;
using System;
using System.Numerics;
using System.Threading;
using AccountUid = Paintvale.HLE.HOS.Services.Account.Acc.UserId;
using ApplicationId = LibHac.Ncm.ApplicationId;

namespace Paintvale.HLE.HOS.Services.Am.AppletOE.ApplicationProxyService.ApplicationProxy
{
