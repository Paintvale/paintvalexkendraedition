...
using Paintvale.HLE.HOS.Services.Fs.FileSystemProxy;
using Paintvale.Memory;
using System;
using System.IO;
using static Paintvale.HLE.Utilities.StringUtils;
using GameCardHandle = System.UInt32;
using IFile = Paintvale.HLE.HOS.Services.Fs.FileSystemProxy.IFile;
...
#pragma warning restore IDE0059
        ...
        public ResultCode OutputAccessLogToSdCard(ServiceCtx context)
        {
            ...
            // FS ends each line with a newline. Remove it because Paintvale logging adds its own newline
