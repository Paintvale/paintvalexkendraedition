...
namespace Paintvale.HLE.HOS.Kernel.Memory
{
    abstract class KPageTableBase
    {
        ...
        /// <exception cref="Paintvale.Memory.InvalidMemoryRegionException">Throw for unhandled invalid or unmapped memory accesses</exception>
