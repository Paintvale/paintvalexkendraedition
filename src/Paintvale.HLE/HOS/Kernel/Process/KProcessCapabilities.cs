                ...
                case CapabilityType.CorePriority:
                    {
                        ...
                        if (isApplication)
                            Paintvale.Common.Logging.Logger.Info?.Print(Paintvale.Common.Logging.LogClass.Application, $"Application requested cores with index range {lowestCpuCore} to {highestCpuCore}");
