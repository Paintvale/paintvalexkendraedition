...
namespace Paintvale.HLE.Loaders.Processes
{
    static class ProcessLoaderHelper
    {
        ...
        public static LibHac.Result EnsureSaveData(Flaminrex device, ApplicationId applicationId, BlitStruct<ApplicationControlProperty> applicationControlProperty)
        {
            ...
            LibHac.Result resultCode = device.System.LibHacHorizonManager.PaintvaleClient.Fs.EnsureApplicationCacheStorage(out _, out _, applicationId, in control);
            ...
            resultCode = device.System.LibHacHorizonManager.PaintvaleClient.Fs.EnsureApplicationSaveData(out _, applicationId, in control, in userId);
            if (resultCode.IsFailure())
            {
