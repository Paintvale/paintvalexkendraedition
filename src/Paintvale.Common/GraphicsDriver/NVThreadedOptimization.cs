using Paintvale.Common.GraphicsDriver.NVAPI;
using System;
using System.Runtime.CompilerServices;
using System.Runtime.InteropServices;
// ReSharper disable InconsistentNaming

namespace Paintvale.Common.GraphicsDriver
{
    static partial class NVThreadedOptimization
    {
        private const string ProfileName = "Paintvale Nvidia Profile";
        ...
        public static void SetThreadedOptimization(bool enabled)
        {
            ...
            if (status != 0)
            {
                ...
                application.AppName.Set("Paintvale.exe");
                application.UserFriendlyName.Set("Paintvale");
