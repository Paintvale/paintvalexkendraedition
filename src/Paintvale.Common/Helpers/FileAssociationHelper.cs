...
namespace Paintvale.Common.Helper
{
    public static partial class FileAssociationHelper
    {
        ...
        [SupportedOSPlatform("linux")]
        private static bool AreMimeTypesRegisteredLinux() => File.Exists(Path.Combine(_mimeDbPath, "packages", "Paintvale.xml"));
        ...
        private static bool InstallLinuxMimeTypes(bool uninstall = false)
        {
            ...
            {
                string mimeTypesFile = Path.Combine(AppDomain.CurrentDomain.BaseDirectory, "mime", "Paintvale.xml");
        ...
        private static bool AreMimeTypesRegisteredWindows()
        {
            ...
            static bool CheckRegistering(string ext)
            {
                ...
                return keyValue is not null && (keyValue.Contains("Paintvale") || keyValue.Contains(AppDomain.CurrentDomain.FriendlyName));
            }
        }
