...
namespace Paintvale.Graphics.Vulkan.Effects
{
    internal class SmaaPostProcessingEffect : IPostProcessingEffect
    {
        ...
        private void RecreateShaders(int width, int height)
        {
            ...
            byte[] edgeShader = EmbeddedResources.Read("Paintvale.Graphics.Vulkan/Effects/Shaders/SmaaEdge.spv");
            byte[] blendShader = EmbeddedResources.Read("Paintvale.Graphics.Vulkan/Effects/Shaders/SmaaBlend.spv");
            byte[] neighbourShader = EmbeddedResources.Read("Paintvale.Graphics.Vulkan/Effects/Shaders/SmaaNeighbour.spv");
        ...
        private void Initialize()
        {
            ...
            MemoryOwner<byte> areaTexture = EmbeddedResources.ReadFileToRentedMemory("Paintvale.Graphics.Vulkan/Effects/Textures/SmaaAreaTexture.bin");
            MemoryOwner<byte> searchTexture = EmbeddedResources.ReadFileToRentedMemory("Paintvale.Graphics.Vulkan/Effects/Textures/SmaaSearchTexture.bin");
