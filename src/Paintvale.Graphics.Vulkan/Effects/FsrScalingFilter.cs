...
using System;
using Extent2D = Paintvale.Graphics.GAL.Extents2D;
...
namespace Paintvale.Graphics.Vulkan.Effects
{
    internal class FsrScalingFilter : IScalingFilter
    {
        ...
        public void Initialize()
        {
            ...
            byte[] scalingShader = EmbeddedResources.Read("Paintvale.Graphics.Vulkan/Effects/Shaders/FsrScaling.spv");
            byte[] sharpeningShader = EmbeddedResources.Read("Paintvale.Graphics.Vulkan/Effects/Shaders/FsrSharpening.spv");
